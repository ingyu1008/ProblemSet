...
/* Berlekamp Massey Algorithm by Koosaga */
...
// End of Berlekamp-Massey Algorithm
...
ll dfs(int lastvisit, int days_left) {
    if (dp[lastvisit][days_left] != -1) return dp[lastvisit][days_left];
...
int main(void)
{
    ...
    std::cout << BerlekampMassey::guess_nth_term(v, N - 1) << "\n";
